...
var units = [
  ...
  { unit: "degC", group: "V", label: "C", stat: " ", dp: 1, min: "", max: "" },
  { unit: "degF", group: "V", label: "F", stat: " ", dp: 1, min: "", max: "" },
  { unit: "RH", group: "V", label: "%", stat: " ", dp: 0, min: "", max: "" },
  { unit: "dewC", group: "V", label: "C", stat: " ", dp: 1, min: "", max: "" },
  { unit: "dewF", group: "V", label: "F", stat: " ", dp: 1, min: "", max: "" },
  { unit: "AirQ", group: "V", label: " ", stat: " ", dp: 3, min: "", max: "" },
    // units: {'ppm', 'hPa', 'percent', 'meters', 'ug/m^3', 'number', 'V', 'bytes', 'degC', 'particles/100mL'}
  { unit: "ppm", group: "V", label: "ppm", stat: " ", dp: 0, min: "", max: "" },
  { unit: "hPa", group: "V", label: "hPa", stat: " ", dp: 3, min: "", max: "" },
  { unit: "percent", group: "V", label: "%", stat: " ", dp: 0, min: "", max: "" },
  { unit: "meters", group: "V", label: "m", stat: " ", dp: 0, min: "", max: "" },
  { unit: "ug/m^3", group: "V", label: "ug/m^3", stat: " ", dp: 0, min: "", max: "" },
  { unit: "number", group: "V", label: " ", stat: " ", dp: 0, min: "", max: "" },
  { unit: "V", group: "V", label: "V", stat: " ", dp: 1, min: "", max: "" },
  { unit: "bytes", group: "V", label: "bytes", stat: " ", dp: 0, min: "", max: "" },
  { unit: "particles/100mL", group: "V", label: "particles/100mL", stat: " ", dp: 0, min: "", max: "" },
...
function source_type(unit) {
  ...
  if (unit == "degC"  || unit == "degF" || unit == "RH" || unit=="dewC" || unit=="dewF" || unit=="AirQ") return "temperature";
  return "power";
}
